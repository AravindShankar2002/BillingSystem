					...
					<div class="card-body p-4 p-md-5">
						...
						<sf:form method="post"
								...
								<div class="col-md-6 mb-4">
									<div class="form-outline">
										<s:bind path="name">
											...
											<sf:input type="text" id="name"
												class="form-control form-control-lg" path="name" name="name" />
							...
							<div class="row">
								<div class="col-md-6 mb-4">
									<div class="form-outline">
										<sf:select class="select form-control-lg" path="catId">
											<option selected="true" disabled="disabled">Select
												Category</option>
											<c:forEach var="category" items="${categoryList}">
												<sf:option value="${category.id}" label="${category.name}" />
											</c:forEach>
										</sf:select>
							...
							<div class="row">
								<div class="col-md-6 mb-4">
									<div class="form-outline">
										<label class="form-label" for="image">Product Image</label> <input
											type="file" class="form-control form-control-lg" name="image"
